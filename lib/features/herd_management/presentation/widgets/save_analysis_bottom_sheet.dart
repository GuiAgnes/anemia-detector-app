...
class SaveAnalysisBottomSheet extends StatefulWidget {
  ...
  @override
  State<SaveAnalysisBottomSheet> createState() => _SaveAnalysisBottomSheetState();
}
  ...
  void _confirm() {
    if (_selectedAnimalId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Selecione um animal para salvar a análise.')),
      );
      return;
    }
        ...
        children: [
          ...
          Consumer<HerdNotifier>(
            builder: (context, notifier, _) {
              ...
              final animals = notifier.animals.where((overview) {
                ...
                final matchesTag = overview.animal.tagId.toLowerCase().contains(lower);
                final name = overview.animal.name ?? overview.animal.nickname ?? '';
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final subtitle = [
                          if ((overview.animal.name ?? overview.animal.nickname) != null)
                            overview.animal.name ?? overview.animal.nickname,
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'Observações sobre o atendimento ou condições do animal',
            ),
          ),
          const SizedBox(height: 16),
          Row(
